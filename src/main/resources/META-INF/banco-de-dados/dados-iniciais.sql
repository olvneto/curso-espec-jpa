...
insert into categoria (nome, categoria_pai_id) values ('Eletrodomésticos', 1);
insert into categoria (nome, categoria_pai_id) values ('Livros', 1);
insert into categoria (nome, categoria_pai_id) values ('Esportes', 1);
insert into categoria (nome, categoria_pai_id) values ('Futebol', 1);
insert into categoria (nome, categoria_pai_id) values ('Natação', 1);
insert into categoria (nome, categoria_pai_id) values ('Notebooks', 1);
insert into categoria (nome, categoria_pai_id) values ('Smartphones', 1);
