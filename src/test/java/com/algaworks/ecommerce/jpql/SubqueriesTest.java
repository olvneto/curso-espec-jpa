...
public class SubqueriesTest extends EntityManagerTest {
    ...
    @Test
    public void pesquisarComAllExec() {
        // Todos os produtos não foram vendidos mais depois que encareceram
//        String jpql = "select p from Produto p where " +
//                " p.preco = ALL (select precoProduto from ItemPedido ip where ip.produto = p)";
...
//                " p.preco = ALL (select precoProduto from ItemPedido where produto = p)";
    ...
    @Test
    public void pesquisarSubqueriesEx() {
...
//                " p.preco = (select max(preco) from Produto)";
    ...
    @Test
    public void pesquisarComExistsEx() {
        String jpql = "select p from Produto p where exists " +
                " (select 1 from ItemPedido ip2 where ip2.produto = p and ip2.precoProduto <> p.preco)";
    ...
    public void pesquisarComIN() {
        String jpql = "select p from Pedido p where p.id in " +
                " (select p2.id from ItemPedido i2 " +
                "      join i2.pedido p2 join i2.produto pro2 where pro2.preco > 100)";//(1, 2, 1, 3, 4)
